define(function(require) {
    ...
    return function resultPlaquesTemplate() {
        ...
        return resultPlaquesComponent({
			...
			popUpWinHeader: displayList.popUpWinHeader,
			popUpWinSubheader: displayList.popUpWinSubheader,
			popUpWinPrize: displayList.popUpWinPrize,
			popUpBigWin: displayList.popUpBigWin,
			losePopUp: displayList.losePopUp,
			popUpLoseHeader: displayList.popUpLoseHeader,
			popUpLoseSubheader: displayList.popUpLoseSubheader
        });
    };
});
