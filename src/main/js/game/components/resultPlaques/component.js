define(function(require) {
    ...
    return function resultPlaques(parts) {
		...
		var winParticles = new PIXI.extras.AnimatedSprite(utils.findFrameSequence("snow00").map(frame => {return PIXI.Texture.fromFrame(frame);}));
